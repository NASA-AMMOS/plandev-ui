...
function main() {
  ...
  const content = [
    ...
    `  packageJsonName: '${process***REMOVED***.npm_package_name}',`,
    `  packageJsonVersion: '${process***REMOVED***.npm_package_version}',`,
    `  tag: '${tag}',`,
    `};\n`,
  ].join('\n');
