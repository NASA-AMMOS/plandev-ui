export enum Queries {
  ...
  DELETE_MODEL_DERIVATION_GROUP = 'delete_model_derivation_group',
  ...
  IMPORT_EXTERNAL_PLAN = 'importExternalPlan',
  ...
  INSERT_MODEL_DERIVATION_GROUP = 'insert_model_derivation_group_one',
