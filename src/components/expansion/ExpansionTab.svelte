...
<script lang="ts">
  ...
  type ExpansionTemplateRendererParams = ICellRendererParams<ExpandedTemplate> & CellRendererParamsActions;

  const legacyBaseColumnDefs: DataGridColumnDef[] = [
    {
      field: 'seq_id',
      filter: 'text',
      headerName: 'Seq ID',
  ...
  let legacyColumnDefs: DataGridColumnDef[] = legacyBaseColumnDefs;
  ...
  const templatingBaseColumnDefs: DataGridColumnDef[] = [
    {
      field: 'id',
      filter: 'number',
      headerName: 'ID',
  ...
  let templateColumnDefs: DataGridColumnDef[] = templatingBaseColumnDefs;

  $: templateColumnDefs = [
    ...templateColumnDefs,
    {
      cellClass: 'action-cell-container',
      cellRenderer: (params: ExpansionTemplateRendererParams) => {
        const actionsDiv = document.createElement('div');
        actionsDiv.className = 'actions-cell';
        new DataGridActions({
          props: {
