...
<script lang="ts">
  ...
  const dispatch = createEventDispatcher<{
    ...
    resolve: {
      confirm: boolean;
      value?: { shouldCopy: boolean; targetPath: string; targetWorkspace: Workspace };
    };
  }>();
...
<StellarDialog bind:open size="auto" className="w-[580px] h-[70vh] max-w-none" title="Move or Duplicate" on:close>
